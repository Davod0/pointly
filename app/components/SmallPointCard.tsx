...
export default function SmallPointCard({ value, selected = false, onClick }: SmallPointCardProps) {
  return (
    <div
      onClick={onClick}
      className={`
        ...
        ${selected
          ? "bg-violet-100 text-violet-700 scale-110 -translate-y-2 ring-4 ring-violet-300"
