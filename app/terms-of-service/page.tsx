...
export default function TermsOfServicePage() {
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-gray-100 to-violet-100 flex flex-col">
      <Header />
      <div className="mx-auto max-w-5xl w-full flex-1 flex justify-center px-4 sm:px-6">
        <div className="mx-auto p-4 sm:p-6 md:p-8 mt-6 sm:mt-8 mb-12 sm:mb-16 bg-white bg-opacity-90 rounded-2xl shadow-sm border border-violet-200">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-serif font-semibold text-gray-900 leading-tight mb-4 sm:mb-6 text-center sm:text-left">
            Terms of Service
          </h1>
